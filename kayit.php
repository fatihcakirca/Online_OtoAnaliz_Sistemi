<html>
  <head>
    <title>ONLINE OTOANALİZ SİSTEMİ</title>
    <meta charset="UTF-8">
...
$sorgu="insert into user (id,isim,email,kullaniciadi,sifre) values (null,'".$isim."','".$email."','".$kullaniciadi."','".$sifre."')";
echo $sorgu;
...
<h1>ONLINE OTOANALİZ SİSTEMİ</h1>
<h3>KAYIT OL</h3>
